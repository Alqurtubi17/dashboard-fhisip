          ...
          <table className="w-full text-xs min-w-[850px]">
            <thead className="bg-slate-50 text-slate-500 text-left border-b border-slate-200">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-center">Tahun Prestasi</th>
              </tr>
            </thead>
                ...
                paginatedItems.map((item) => (
                  <tr key={item.id} className="hover:bg-slate-50/70 transition">
                    ...
                    <td className="px-4 py-3 text-center font-extrabold">
                      <span className="px-2.5 py-1 rounded-lg bg-slate-100 text-slate-800 font-extrabold text-xs border border-slate-200">
                        {item.tahun}
                      </span>
                    </td>
                  </tr>
